...
V_fixed = I_fixed.*R_fixed;	
P_fixed = (I_fixed.*V_fixed)*panel_number ;                 % [W]
Power_fixed_hourly = (P_fixed(1)+P_fixed(3))/2;             % [Whr]
Power_fixed_power_daily = Power_fixed_hourly*sun_hours;
Power_fixed_power_year = Power_fixed_power_daily*365;
Power_fixed_hourly_occluded = (P_fixed(2)+P_fixed(4))/2;
Power_fixed_power_daily_occluded = Power_fixed_hourly_occluded*sun_hours;
Power_fixed_power_year_occluded = Power_fixed_power_daily_occluded*365;
...
Power_MTTP_hourly = (P_MTTP(1)+P_MTTP(3))/2;
Power_MTTP_power_daily = Power_MTTP_hourly*sun_hours;
Power_MTTP_power_year = Power_MTTP_power_daily*365;
Power_MTTP_hourly_occluded = (P_MTTP(2)+P_MTTP(4))/2;
Power_MTTP_power_daily_occluded = Power_MTTP_hourly_occluded*sun_hours;
Power_MTTP_power_year_occluded = Power_MTTP_power_daily_occluded*365;

Power_difference = (abs(Power_MTTP_hourly-Power_fixed_hourly)/Power_MTTP_hourly)*100;
Power_difference_occluded = (abs(Power_MTTP_hourly_occluded-Power_fixed_hourly_occluded)/Power_MTTP_hourly_occluded)*100;
...
if ismember(2,view) || ismember(2,output)
    ...
    r1_1 = refline(1/10,0);
    set(r1_1,...
        'DisplayName','Inverse slope fixed resistance',...
        'Color',[0.18 0.18 0.18],...
        'Linestyle','-',...
        'LineWidth',1);
    ...
    r1_2 = text(...
        'FontSize',12,...
        'Rotation',17.5,...
        'String',{'Inverse slope of fixed resistance 10 \Omega'},...
